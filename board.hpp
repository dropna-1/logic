...
public:
    ...
    vector<int> secrets;
    vector<int> zone;
    Space(vector<int> neighbors, vector<int> zone, vector<int> secrets = {}) 
    :neighbors(neighbors), zone(zone), secrets(secrets){}
};
...
public:
    Board(){
        spaces.push_back({{1, 2}, {1}, {11, 19, 23}});
